...
In order to support loading of multiple wallets in masterleisurecoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is masterleisurecoin.cpp.
...
Changes to masterleisurecoin.cpp
----------------------
masterleisurecoin.cpp is the entry point into masterleisurecoin-qt, and as such, will require some minor modifications to provide hooks for
