Masterleisurecoin Core
=====================

Intro
-----
Masterleisurecoin (MLC) is a sustainable cryptocurrency modeled after
...
high-powered mining hardware. Masterleisurecoin utilizes an energy efficient proof-of-stake algorithm,
...
Setup
-----
Unpack the files into a directory and run masterleisurecoin-qt.exe.

Masterleisurecoin Core is the original Masterleisurecoin client and it builds the backbone of the network.
However, it downloads and stores the entire history of Masterleisurecoin transactions;
