Contributing to Masterleisurecoin Core
==================================

The Masterleisurecoin Core project operates an open contributor model where anyone is
...
to your fork until you have satmlcied all feedback.
...
The following applies to code changes to the Masterleisurecoin Core project, and is not to be
confused with overall Masterleisurecoin Network Protocol consensus changes.

Whether a pull request is merged into Masterleisurecoin Core rests with the project merge
...
Patches that change Masterleisurecoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Masterleisurecoin consensus, it must have been
...
The project leader is the release manager for each Masterleisurecoin Core release.
