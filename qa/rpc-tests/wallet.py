...
#   c) node1 mines 32 blocks, so now node 0 has 500000MLC, node 1 has 4250MLC, node2 has none.
#   d) node0 sends 601 MLC to node2, in two transactions (301 MLC, then 300 MLC).
