...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Masterleisurecoin Core masterleisurecoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  masterleisurecoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded masterleisurecoin transaction") + "\n" +
                               "  masterleisurecoin-tx [options] -create [commands]   " + _("Create hex-encoded masterleisurecoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded masterleisurecoin transaction
