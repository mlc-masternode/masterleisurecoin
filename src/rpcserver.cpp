...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Masterleisurecoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Masterleisurecoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Masterleisurecoin features */
        {"masterleisurecoin", "masternode", &masternode, true, true, false},
        {"masterleisurecoin", "listmasternodes", &listmasternodes, true, true, false},
        {"masterleisurecoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"masterleisurecoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"masterleisurecoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"masterleisurecoin", "masternodedebug", &masternodedebug, true, true, false},
        {"masterleisurecoin", "startmasternode", &startmasternode, true, true, false},
        {"masterleisurecoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"masterleisurecoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"masterleisurecoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"masterleisurecoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"masterleisurecoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"masterleisurecoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"masterleisurecoin", "mnbudget", &mnbudget, true, true, false},
        {"masterleisurecoin", "preparebudget", &preparebudget, true, true, false},
        {"masterleisurecoin", "submitbudget", &submitbudget, true, true, false},
        {"masterleisurecoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"masterleisurecoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"masterleisurecoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"masterleisurecoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"masterleisurecoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"masterleisurecoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"masterleisurecoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"masterleisurecoin", "checkbudgets", &checkbudgets, true, true, false},
        {"masterleisurecoin", "mnsync", &mnsync, true, true, false},
        {"masterleisurecoin", "spork", &spork, true, true, false},
        {"masterleisurecoin", "preparecommunityproposal", &preparecommunityproposal, true, true, false},
        {"masterleisurecoin", "submitcommunityproposal", &submitcommunityproposal, true, true, false},
        {"masterleisurecoin", "getcommunityinfo", &getcommunityinfo, true, true, false},
        {"masterleisurecoin", "checkcommunityproposals", &checkcommunityproposals, true, true, false},
        {"masterleisurecoin", "getcommunityproposalvotes", &getcommunityproposalvotes, true, true, false},
        {"masterleisurecoin", "mncommunityvote", &mncommunityvote, true, true, false},
...
{
    return "> masterleisurecoin-cli " + methodname + " " + args + "\n";
}
