...
// Copyright (c) 2019 The Masterleisurecoin developers
...
#if defined(NDEBUG)
#error "Masterleisurecoin cannot be compiled without assertions."
#endif
...
/** Fees smaller than this (in umlc) are considered zero fee (for relaying and mining)
...
int64_t GetBlockValue(int nHeight)
{
	...
	nSubsidy = 1500000 * COIN;
        ...
        nSubsidy = 5555.5 * COIN;
    else if (nHeight > 10000 && nHeight <= 31001)
        nSubsidy = 250 * COIN;
    else if (nHeight > 31001 && nHeight <= 52002)
        nSubsidy = 500 * COIN;
    else if (nHeight > 52002 && nHeight <= 73003)
        nSubsidy = 750 * COIN;
    else if (nHeight > 73003 && nHeight <= 94004)
        nSubsidy = 1000 * COIN;
    else if (nHeight > 94004 && nHeight <= 115005)
        nSubsidy = 1250 * COIN;
    else if (nHeight > 115005 && nHeight <= 136006)
        nSubsidy = 1500 * COIN;
    else if (nHeight > 136006 && nHeight <= 157007)
        nSubsidy = 1750 * COIN;
    else if (nHeight > 157007 && nHeight <= 178008)
        nSubsidy = 2000 * COIN;
    else if (nHeight > 178008 && nHeight <= 199009)
        nSubsidy = 2250 * COIN;
    else if (nHeight > 199009 && nHeight <= 220010)
        nSubsidy = 2500 * COIN;
    else if (nHeight > 220010 && nHeight <= 241011)
        nSubsidy = 2750 * COIN;
    else if (nHeight > 241011 && nHeight <= 262012)
        nSubsidy = 3000 * COIN;
    else if (nHeight > 262012 && nHeight <= 283013)
        nSubsidy = 3250 * COIN;
    else if (nHeight > 283013 && nHeight <= 304014)
        nSubsidy = 3500 * COIN;
    else if (nHeight > 304014 && nHeight <= 325015)
        nSubsidy = 3750 * COIN;
    else if (nHeight > 325015 && nHeight <= 346016)
        nSubsidy = 4000 * COIN;
    else if (nHeight > 346016 && nHeight <= 367017)
        nSubsidy = 4250 * COIN;
    else if (nHeight > 304014 && nHeight <= 325015)
        nSubsidy = 3750 * COIN;
    else if (nHeight > 325015 && nHeight <= 346016)
        ...
        nSubsidy = 4250 * COIN;
    else if (nHeight > 367017 && nHeight <= 388018)
        nSubsidy = 4500 * COIN;
    else if (nHeight > 388018 && nHeight <= 409019)
        nSubsidy = 4750 * COIN;
    else if (nHeight > 409019 && nHeight <= 430020)
        nSubsidy = 5000 * COIN;
    else if (nHeight > 430020 && nHeight <= 451021)
        nSubsidy = 5250 * COIN;
    else if (nHeight > 451021 && nHeight <= 472022)
        nSubsidy = 5500 * COIN;
    else if (nHeight > 472022 && nHeight <= 493023)
        nSubsidy = 5750 * COIN;
    else if (nHeight > 493023 && nHeight <= 514024)
        nSubsidy = 6000 * COIN;
    else
        nSubsidy = 2500 * COIN;
...
int64_t GetMasternodePayment(int nHeight, int64_t blockValue, int nMasternodeCount)
{
    ...
    else if (nHeight >10000 && nHeight <= 94004)
    ret = blockValue * 0.8; // 80% of block reward
    else if (nHeight > 94004 && nHeight <= 178008)
    ret = blockValue * 0.85; // 85% of block reward
    else if (nHeight > 178008)
...
{
    RenameThread("masterleisurecoin-scriptch");
