                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Masterleisurecoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a MLC address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and masterleisurecoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Masterleisurecoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Masterleisurecoin Core"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/qt-project.org/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for Masterleisurecoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your MLC addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_black"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified MLC addresses"));
    ...
    openAction->setStatusTip(tr("Open a masterleisurecoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Masterleisurecoin Core help message to get a list with possible Masterleisurecoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Masterleisurecoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Masterleisurecoin network", "", count));
}
...
{
    QString strTitle = tr("Masterleisurecoin Core"); // default title
    ...
    // Append title to "Masterleisurecoin - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
