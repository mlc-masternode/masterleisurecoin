...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Masterleisurecoin Core"),
     ...
     * override -datadir in the masterleisurecoin.conf file in the default data directory
     * (to be consistent with masterleisurecoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
