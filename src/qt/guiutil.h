...
/** Utility functions used by the Masterleisurecoin Qt UI.
 */
namespace GUIUtil
{
...
// Render MLC addresses in monospace font
...
// Parse "masterleisurecoin:" URI into recipient object, return true on successful parsing
